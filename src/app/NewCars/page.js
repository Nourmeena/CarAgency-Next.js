...
export default async function Home() {
    ...
    const newCars = cars.filter((car) => car.category === "new")
    return (
        <div>
            <h3 style={{ textAlign: 'center', color: 'red', fontFamily: 'Arial, sans-serif', fontWeight: 'bold', paddingBottom: 20 }}>
                Our collection of the best newst cars
            </h3>
            {newCars.map((car) => (
                <div key={car.id}>
                    <Card className="mb-3">
