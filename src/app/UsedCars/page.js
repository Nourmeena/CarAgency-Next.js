...
export default async function Home() {
    ...
    const useCars=cars.filter((car)=>car.category==="used")
    return (
        <div>
            <h3 style={{ textAlign: 'center', color: 'red', fontFamily: 'Arial, sans-serif', fontWeight: 'bold',paddingBottom:20 }}>Our collection of the used car</h3>
            {useCars.map((car) => (
                <div key={car.id}>
                    <Card className="mb-3">
                        <Row className="g-0">
